(function(root) {
		...
		*/
		addEffect: {
			...
			value: function(effect) {
				...
				console.log(this.effectConnectors);
	...
	*/
	function Filter(options, type) {
		...
		this.filterNode = Pz.context.createBiquadFilter();
		...
		this.wetGainNode.connect(this.filterNode);
	...
	Pizzicato.Effects.Distortion = function(options) {
		...
		this.wetGainNode.connect(this.waveShaperNode);
